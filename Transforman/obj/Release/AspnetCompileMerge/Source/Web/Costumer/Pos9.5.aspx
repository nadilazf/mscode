<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Pos9__5.aspx.cs" Inherits="Transforman.Web.Costumer.Pos9__5" %>
    ...
    <script>
        ...
        $('.SelectedDetail').on('click', function () {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "Pos9.5.aspx/GetDataPenumpangById",
                data: "{'id' :'" + id + "'}",
                dataType: "json",
                success: function (data) {
                    var data = JSON.parse(data.d);
