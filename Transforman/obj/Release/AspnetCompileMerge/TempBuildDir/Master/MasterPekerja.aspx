<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MasterPekerja.aspx.cs" Inherits="Transforman.master.MasterPekerja" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Create Master Pekerja</h1>
            </div>
        </div>
        <!-- /.row -->
        <div class="row">
    ...
    <script>
       ...
       <%-- var iTransaksi = $.parseJSON(_App);
        ...
        var seltxtApproval = $('#txtApproval');

        $.each(iTransaksi, function (key, value) {

            seltxtApproval.append('<option value="' + value.No_Pek + '">' + value.Nama + '</option>');
        });--%>
        ...
        if (objPegawai.length > 0) {
            ...
            for (var i = 0; i < objPegawai.length; i++) {
                ...
                Pegawai.Fungsi = objPegawai[i]["Fungsi"];
                Pegawai.Position = objPegawai[i]["Position"];
        ...
        $('.edit').on('click', function () {
            ...
            $.ajax({
                ...
                url: "MasterPekerja.aspx/GetDataPegawaiById",
                data: "{'NoPek':'" + id +"'}",
                dataType: "json",
        ...
        $('.delete').on('click', function () {
            ...
            if (r == true) {
                ...
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "MasterPekerja.aspx/DeletePegawaiById",
                    data: "{'NoPek':'" + id + "'}",
                    dataType: "json",
                    success: function (data) {
        ...
        $('#btnSave').on('click', function () {
            ...
            if (Fungsi == "")
                validation += "Silahkan isi Fungsi \n";
